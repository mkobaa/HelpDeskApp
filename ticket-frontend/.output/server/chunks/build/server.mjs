import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { ref, toRef, isRef, hasInjectionContext, inject, getCurrentInstance, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { j as defuFn, k as klona, f as destr, e as createError$1, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as getRequestHeader, q as isEqual, s as sanitizeStatusCode, r as setCookie, t as getCookie, v as deleteCookie, x as getContext, $ as $fetch$1, y as baseURL, z as createHooks, A as executeAsync, B as toRouteMatcher, C as createRouter$1, D as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "login",
    path: "/login",
    component: () => import('./login-CLOVW9AY.mjs')
  },
  {
    name: "logout",
    path: "/logout",
    component: () => import('./logout-CkIkYetq.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./profile-D6isI-Fi.mjs')
  },
  {
    name: "user",
    path: "/user",
    component: () => import('./index-DQBiilgW.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./index-BtC2XlKr.mjs')
  },
  {
    name: "user-profile",
    path: "/user/profile",
    component: () => import('./profile-D4yEpzh_.mjs')
  },
  {
    name: "admin-profile",
    path: "/admin/profile",
    component: () => import('./profile-BOnZumZk.mjs')
  },
  {
    name: "admin-users-id",
    path: "/admin/users/:id()",
    component: () => import('./_id_-gcskjRPf.mjs')
  },
  {
    name: "supervisor",
    path: "/supervisor",
    component: () => import('./index-B31zfMgC.mjs')
  },
  {
    name: "technician",
    path: "/technician",
    component: () => import('./index-BIdhktCa.mjs')
  },
  {
    name: "user-survey-id",
    path: "/user/survey/:id()",
    component: () => import('./_id_-CwMs7EN4.mjs')
  },
  {
    name: "admin-users",
    path: "/admin/users",
    component: () => import('./index-B0V7oMkR.mjs')
  },
  {
    name: "user-tickets-id",
    path: "/user/tickets/:id()",
    component: () => import('./_id_-DZQpWN2M.mjs')
  },
  {
    name: "admin-users-create",
    path: "/admin/users/create",
    component: () => import('./create-5uFG1o2C.mjs')
  },
  {
    name: "supervisor-profile",
    path: "/supervisor/profile",
    component: () => import('./profile-BRg9BK_L.mjs')
  },
  {
    name: "technician-profile",
    path: "/technician/profile",
    component: () => import('./profile-Z08luKHV.mjs')
  },
  {
    name: "user-tickets",
    path: "/user/tickets",
    component: () => import('./index-D7FuZct-.mjs')
  },
  {
    name: "admin-history",
    path: "/admin/history",
    component: () => import('./index-BRw5C12v.mjs')
  },
  {
    name: "user-tickets-create",
    path: "/user/tickets/create",
    component: () => import('./create-D-NvP49y.mjs')
  },
  {
    name: "admin-categories-id",
    path: "/admin/categories/:id()",
    component: () => import('./_id_-B4yWrdFy.mjs')
  },
  {
    name: "admin-categories",
    path: "/admin/categories",
    component: () => import('./index-DgTHcNK-.mjs')
  },
  {
    name: "admin-categories-create",
    path: "/admin/categories/create",
    component: () => import('./create-COZqxBpr.mjs')
  },
  {
    name: "supervisor-tickets-id",
    path: "/supervisor/tickets/:id()",
    component: () => import('./_id_-B6eDN_50.mjs')
  },
  {
    name: "technician-tickets-id",
    path: "/technician/tickets/:id()",
    component: () => import('./_id_-DZu1JBN8.mjs')
  },
  {
    name: "supervisor-reports",
    path: "/supervisor/reports",
    component: () => import('./index-BtKfpmZi.mjs')
  },
  {
    name: "supervisor-tickets",
    path: "/supervisor/tickets",
    component: () => import('./index-OY0dVrhe.mjs')
  },
  {
    name: "technician-tickets",
    path: "/technician/tickets",
    component: () => import('./index-Bwgt2XUd.mjs')
  },
  {
    name: "supervisor-technicians-id",
    path: "/supervisor/technicians/:id()",
    component: () => import('./_id_-l6Z0d-L_.mjs')
  },
  {
    name: "supervisor-technicians",
    path: "/supervisor/technicians",
    component: () => import('./index-BX8A9_Pt.mjs')
  }
];
...
const namedMiddleware = {
  "auth-client": () => import('./auth.client-D7VHPuIF.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./index-Db0gMLsE.mjs').then((n) => n.i).then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ZW622IJt.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CbV6b7Bh.mjs'));
...
export { _export_sfc as _, useAppConfig as a, useCookie as b, useState as c, useRoute as d, entry_default as default, useRouter as e, useNuxtApp as f, useRuntimeConfig as g, nuxtLinkDefaults as h, appConfig as i, asyncDataDefaults as j, createError as k, defineNuxtPlugin as l, navigateTo as n, resolveRouteObject as r, useHead as u };
