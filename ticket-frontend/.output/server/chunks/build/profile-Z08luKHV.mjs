...
import { defineComponent, withAsyncContext, resolveComponent, withCtx, unref, createTextVNode, createVNode, createBlock, createCommentVNode, toDisplayString, openBlock, useSSRContext } from 'vue';
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_UDashboardPageHeader, {
                    title: unref(user)?.username || "Profile",
                  ...
                  _push3(ssrRenderComponent(_component_UCard, null, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (unref(error)) {
                          _push4(`<div class="mt-4 text-sm text-error"${_scopeId3}>Failed to load profile.</div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
                        return [
                          ...
                          }, "Failed to load profile.")) : createCommentVNode("", true)
                        ];
                      }
                    }),
                    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/technician/profile.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=profile-Z08luKHV.mjs.map
