...
import { u as useLocale, t as tv, c as _sfc_main$1, _ as _sfc_main$3, b as _sfc_main$2 } from './usePortal-BKdXuyUd.mjs';
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                __props.avatar ? (openBlock(), createBlock(_sfc_main$1, mergeProps({
                  ...
                  "data-slot": "avatar",
                  class: ui.value.avatar({ class: props.ui?.avatar })
                }), null, 16, ["size", "class"])) : __props.icon ? (openBlock(), createBlock(_sfc_main$3, {
                  key: 1,
                  name: __props.icon,
                  "data-slot": "icon",
                  class: ui.value.icon({ class: props.ui?.icon })
...
//# sourceMappingURL=Alert-D75idXAT.mjs.map
