import { useSlots, ref, inject, computed, mergeProps, unref, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, createVNode, resolveDynamicComponent, toRef, watch, toValue, provide, mergeModels, useModel, createTextVNode, isRef, useSSRContext } from 'vue';
import { E as serialize, D as defu, q as isEqual } from '../nitro/nitro.mjs';
...
import { a as useAppConfig, i as appConfig, d as useRoute } from './server.mjs';
import { reactivePick, reactiveOmit, useDebounceFn } from '@vueuse/core';
import { createTV } from 'tailwind-variants';
import { _ as __nuxt_component_0 } from './index-Db0gMLsE.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-Bj7IzWuU.mjs';
          ...
          if (_push2) {
            ...
            return [
              __props.custom ? renderSlot(_ctx.$slots, "default", mergeProps({ key: 0 }, {
                ...
                isExternal,
                active: isLinkActive({ route: linkRoute, isActive, isExactActive })
              })) : (openBlock(), createBlock(_sfc_main$5, mergeProps({ key: 1 }, {
                ..._ctx.$attrs,
                ...__props.exact && isExactActive ? { "aria-current": props.ariaCurrentValue } : {},
                as: __props.as,
                type: __props.type,
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$2), ...appConfig2.ui?.chip || {} })({
      color: props.color,
      size: size.value,
...
const _sfc_main$1 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const { size } = useAvatarGroup(props);
    const ui = computed(() => tv({ extend: tv(theme$1), ...appConfig2.ui?.avatar || {} })({
      size: size.value
    }));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(props.chip ? _sfc_main$2 : unref(Primitive)), mergeProps({
        as: as.value.root
              ...
              _push2(ssrRenderComponent(unref(Slot), _ctx.$attrs, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      renderSlot(_ctx.$slots, "default", {}, () => [
                        __props.icon ? (openBlock(), createBlock(_sfc_main$3, {
                          key: 0,
                          name: __props.icon,
                          "data-slot": "icon",
                          class: ui.value.icon({ class: props.ui?.icon })
                  ...
                  return [
                    renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                      unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$3, {
                        ...
                        "data-slot": "leadingIcon",
                        class: ui.value.leadingIcon({ class: props.ui?.leadingIcon, active })
                      }, null, 8, ["name", "class"])) : !!__props.avatar ? (openBlock(), createBlock(_sfc_main$1, mergeProps({
                        key: 1,
                        size: props.ui?.leadingAvatarSize || ui.value.leadingAvatarSize()
                      }, __props.avatar, {
                        "data-slot": "leadingAvatar",
...
export { pickLinkProps as A, _sfc_main$5 as B, _sfc_main$3 as _, _sfc_main$4 as a, _sfc_main as b, _sfc_main$1 as c, formStateInjectionKey as d, formErrorsInjectionKey as e, formBusInjectionKey as f, getSlotChildrenText as g, formInputsInjectionKey as h, formLoadingInjectionKey as i, formOptionsInjectionKey as j, inputIdInjectionKey as k, formFieldInjectionKey as l, useFormField as m, usePortal as n, omit as o, pick as p, useFieldGroup as q, useComponentIcons as r, isArrayOfArray as s, tv as t, useLocale as u, get as v, compare as w, _sfc_main$2 as x, looseToNumber as y, getDisplayValue as z };
//# sourceMappingURL=usePortal-BKdXuyUd.mjs.map
