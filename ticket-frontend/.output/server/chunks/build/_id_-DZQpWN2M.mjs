...
import { _ as _sfc_main$1 } from './Card-o7xn3WFg.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: users, error: usersError, status: usersStatus } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("technicians", () => getTechnicians(), {
      server: false,
      lazy: true,
      default: () => []
    })), __temp = await __temp, __restore(), __temp);
            ...
            _push2(ssrRenderComponent(_component_UDashboardPage, { class: "flex flex-col flex-1 min-w-0 overflow-hidden" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                      ...
                      if (_push4) {
                        if (!unref(isEditing)) {
                          ...
                          _push4(ssrRenderComponent(_component_UFormGroup, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<p class="text-base text-gray-900"${_scopeId4}>${ssrInterpolate(unref(technicianDisplayName))}</p>`);
                              } else {
                                return [
                                  createVNode("p", { class: "text-base text-gray-900" }, toDisplayString(unref(technicianDisplayName)), 1)
                                ];
                              }
                            }),
                            _: 1
                  ...
                  _push3(`</div>`);
                  _push3(ssrRenderComponent(_component_TicketComments, { ticketId: unref(ticketId) }, null, _parent3, _scopeId2));
                } else {
                  return [
                    ...
                    createVNode(_component_TicketComments, { ticketId: unref(ticketId) }, null, 8, ["ticketId"])
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/user/tickets/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-DZQpWN2M.mjs.map
