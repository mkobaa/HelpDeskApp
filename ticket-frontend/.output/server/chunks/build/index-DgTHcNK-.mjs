...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: categories, status, refresh } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("categories", () => getCategories(), {
      server: false,
      lazy: false,
      default: () => []
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CategoriesTable.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_4 = Object.assign(_sfc_main$1, { __name: "CategoriesTable" });
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_CategoriesTable = __nuxt_component_4;
        ...
        _push2(ssrRenderComponent(_component_UDashboardPage, { class: "flex flex-col flex-1 min-w-0 overflow-hidden" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              _push3(`</div>`);
              _push3(ssrRenderComponent(_component_CategoriesTable, { class: "flex-1 w-full" }, null, _parent3, _scopeId2));
              _push3(`</div>`);
            } else {
              return [
                ...
                createVNode("div", { class: "flex flex-col flex-1 gap-6 p-6 overflow-auto" }, [
                  ...
                  createVNode(_component_CategoriesTable, { class: "flex-1 w-full" })
                ])
              ];
            }
          }),
...
//# sourceMappingURL=index-DgTHcNK-.mjs.map
