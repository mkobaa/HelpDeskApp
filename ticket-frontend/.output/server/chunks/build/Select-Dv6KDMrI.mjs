...
import { n as usePortal, m as useFormField, q as useFieldGroup, r as useComponentIcons, t as tv, s as isArrayOfArray, _ as _sfc_main$3, c as _sfc_main$1, v as get, x as _sfc_main$2, y as looseToNumber, z as getDisplayValue } from './usePortal-BKdXuyUd.mjs';
                  ...
                  return [
                    ...
                    unref(isTrailing) || !!slots.trailing ? (openBlock(), createBlock("span", {
                      ...
                      renderSlot(_ctx.$slots, "trailing", {
                        ...
                        unref(trailingIconName) ? (openBlock(), createBlock(_sfc_main$3, {
                          key: 0,
                          name: unref(trailingIconName),
                          "data-slot": "trailingIcon",
                          class: ui.value.trailingIcon({ class: props.ui?.trailingIcon })
                                          ...
                                          return [
                                            renderSlot(_ctx.$slots, "item", {
                                              ...
                                              renderSlot(_ctx.$slots, "item-leading", {
                                                ...
                                                isSelectItem(item) && item.icon ? (openBlock(), createBlock(_sfc_main$3, {
                                                  key: 0,
                                                  name: item.icon,
                                                  "data-slot": "itemLeadingIcon",
                                                  class: ui.value.itemLeadingIcon({ class: [props.ui?.itemLeadingIcon, item.ui?.itemLeadingIcon] })
                                                }, null, 8, ["name", "class"])) : isSelectItem(item) && item.avatar ? (openBlock(), createBlock(_sfc_main$1, mergeProps({
                                                  key: 1,
                                                  size: item.ui?.itemLeadingAvatarSize || props.ui?.itemLeadingAvatarSize || ui.value.itemLeadingAvatarSize()
                                                }, { ref_for: true }, item.avatar, {
                                                  "data-slot": "itemLeadingAvatar",
                                                  class: ui.value.itemLeadingAvatar({ class: [props.ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar] })
                                                }), null, 16, ["size", "class"])) : isSelectItem(item) && item.chip ? (openBlock(), createBlock(_sfc_main$2, mergeProps({
                                                  key: 2,
                                                  size: item.ui?.itemLeadingChipSize || props.ui?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                                                  inset: "",
                                                  standalone: ""
...
//# sourceMappingURL=Select-Dv6KDMrI.mjs.map
