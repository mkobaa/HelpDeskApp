...
import { resolveComponent, withCtx, createTextVNode, createVNode, defineComponent, withAsyncContext, computed, mergeProps, unref, toDisplayString, useSSRContext } from 'vue';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: users, status, refresh } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("users", () => getUsers(), {
      server: false,
      lazy: false,
      default: () => []
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UTable, mergeProps({
        ...
        "cell-username": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(row.original.username)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(row.original.username), 1)
                  ];
                }
              }),
              _: 2
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/UsersTable.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_4 = Object.assign(_sfc_main$1, { __name: "UsersTable" });
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_UButton = _sfc_main$2;
  const _component_UsersTable = __nuxt_component_4;
        ...
        _push2(ssrRenderComponent(_component_UDashboardPage, { class: "flex flex-col flex-1 min-w-0 overflow-hidden" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              _push3(`</div>`);
              _push3(ssrRenderComponent(_component_UsersTable, { class: "flex-1 w-full" }, null, _parent3, _scopeId2));
              _push3(`</div>`);
            } else {
              return [
                ...
                createVNode("div", { class: "flex flex-col flex-1 gap-6 p-6 overflow-auto" }, [
                  ...
                  createVNode(_component_UsersTable, { class: "flex-1 w-full" })
                ])
              ];
            }
          }),
...
//# sourceMappingURL=index-B0V7oMkR.mjs.map
