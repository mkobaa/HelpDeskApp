import { computed, ref, unref, mergeProps, withCtx, renderSlot, useSSRContext, isRef, watch, useSlots, toRef, toHandlers, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, createVNode, Fragment, resolveDynamicComponent, onScopeDispose, mergeModels, useModel, useId, reactive, renderList, withModifiers, defineComponent, resolveComponent, createSlots } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass, ssrRenderVNode, ssrRenderAttrs, ssrRenderList } from "vue/server-renderer";
import { createContext, Primitive, useForwardProps, useForwardPropsEmits, DialogRoot, DialogTrigger, DialogPortal, DialogOverlay, DialogContent, VisuallyHidden, DialogTitle, DialogDescription, DialogClose, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow, AccordionTrigger, AccordionItem, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuLink, NavigationMenuContent, AccordionContent, AccordionRoot, NavigationMenuRoot, NavigationMenuList, NavigationMenuIndicator, NavigationMenuViewport } from "reka-ui";
import { t as tv, m as useLocale, x as _sfc_main$f, n as usePortal, o as useFieldGroup, p as useComponentIcons, _ as _sfc_main$g, b as _sfc_main$h, q as isArrayOfArray, l as get, a as _sfc_main$i, A as pickLinkProps, B as _sfc_main$j, s as _sfc_main$k } from "./usePortal-BKdXuyUd.js";
import { f as useNuxtApp, a as useAppConfig, b as useCookie, d as useRoute, g as useRuntimeConfig } from "../server.mjs";
import { defu } from "/home/mkobaa/workspace/HelpDeskApp/ticket-frontend/node_modules/defu/dist/defu.mjs";
import { useStorage, reactiveOmit, reactivePick, createReusableTemplate, createSharedComposable } from "@vueuse/core";
...
import { _ as __nuxt_component_0 } from "./nuxt-link-Bj7IzWuU.js";
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$g, {
                  ...
                  "data-slot": "leadingIcon",
                  class: ui.value.leadingIcon({ class: props.ui?.leadingIcon })
                }, null, 8, ["name", "class"])) : !!__props.avatar ? (openBlock(), createBlock(_sfc_main$h, mergeProps({
                  key: 1,
                  size: props.ui?.leadingAvatarSize || ui.value.leadingAvatarSize()
                }, __props.avatar, {
                  "data-slot": "leadingAvatar",
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.avatar ? (openBlock(), createBlock(_sfc_main$h, mergeProps({
                    key: 0,
                    size: item.ui?.linkLeadingAvatarSize || props.ui?.linkLeadingAvatarSize || ui.value.linkLeadingAvatarSize()
                  }, item.avatar, {
                    "data-slot": "linkLeadingAvatar",
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.orientation === "vertical" && item.type === "label" && !__props.collapsed) {
                    ...
                    _push3(ssrRenderComponent(_sfc_main$i, mergeProps(__props.orientation === "vertical" && item.children?.length && !__props.collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
                              ...
                              if (_push5) {
                                if (__props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover)) {
                                  _push5(ssrRenderComponent(_sfc_main$5, mergeProps({ ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                      ...
                                      if (_push6) {
                                        ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                          ...
                                          ssrRenderList(item.children, (childItem, childIndex) => {
                                            ...
                                            _push6(ssrRenderComponent(_sfc_main$i, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(unref(NavigationMenuLink), {
                                                    ...
                                                    default: withCtx((_3, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        _push8(ssrRenderComponent(_sfc_main$j, mergeProps({ ref_for: true }, childSlotProps, {
                                                          "data-slot": "childLink",
                                                        ...
                                                        return [
                                                          createVNode(_sfc_main$j, mergeProps({ ref_for: true }, childSlotProps, {
                                                            "data-slot": "childLink",
                                                            class: ui.value.childLink({ class: [props.ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                          }), {
                                                            default: withCtx(() => [
                                            ...
                                            createVNode("ul", {
                                              ...
                                              (openBlock(true), createBlock(Fragment, null, renderList(item.children, (childItem, childIndex) => {
                                                return openBlock(), createBlock("li", {
                                                  ...
                                                  createVNode(_sfc_main$i, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                    ...
                                    default: withCtx((_3, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(ssrRenderComponent(_sfc_main$j, mergeProps(slotProps, {
                                          "data-slot": "link",
                                  ...
                                  _push5(ssrRenderComponent(_sfc_main$j, mergeProps(slotProps, {
                                    "data-slot": "link",
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$5, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ...
                                    _: 2
                                  }, 1040, ["text"])) : (openBlock(), createBlock(_sfc_main$j, mergeProps({ key: 2 }, slotProps, {
                                    "data-slot": "link",
                                    class: ui.value.link({ class: [props.ui?.link, item.ui?.link, item.class], active: active || item.active, disabled: !!item.disabled, level: __props.orientation === "horizontal" || level > 0 })
                                  }), {
                                    default: withCtx(() => [
                                ...
                                if (_push5) {
                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                    ...
                                    ssrRenderList(item.children, (childItem, childIndex) => {
                                      ...
                                      _push5(ssrRenderComponent(_sfc_main$i, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                          ...
                                          if (_push6) {
                                            _push6(ssrRenderComponent(unref(NavigationMenuLink), {
                                              ...
                                              default: withCtx((_3, _push7, _parent7, _scopeId6) => {
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$j, mergeProps({ ref_for: true }, childSlotProps, {
                                                    "data-slot": "childLink",
                                                    class: ui.value.childLink({ class: [props.ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                  }), {
                  ...
                  return [
                    ...
                    ], 2)) : item.type !== "label" ? (openBlock(), createBlock(_sfc_main$i, mergeProps({ key: 1 }, __props.orientation === "vertical" && item.children?.length && !__props.collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
...
//# sourceMappingURL=navbar-DByaTdfk.js.map
