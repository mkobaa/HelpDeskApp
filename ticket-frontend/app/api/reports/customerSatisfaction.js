export const getCustomerSatisfaction = async (criteria = {}) => {
  ...
  if (criteria.technician_id) params.append('technician_id', criteria.technician_id)
  ...
  let url = `${API_BASE}/api/reports/customer-satisfaction`
